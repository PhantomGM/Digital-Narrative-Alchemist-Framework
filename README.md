...
This repository holds three different kinds of thing, and they are not under the
same terms.

### The framework — code, decoders, templates, schemas

[PolyForm Noncommercial 1.0.0](LICENSE.txt).

Free for any noncommercial purpose: hobby projects, personal study, private
games, teaching, and research. Run it, change it, build on it, share it.

Commercial use is not granted by that licence. If you want to use any part of
this in something you make money from, that is fine by me — but it needs a
separate licence. Open an issue or get in touch and we will work it out.

This covers the decoder prompts in `src/layer5_dna_substrate/decoders/` and the
page templates as well as the Python. They are the method, not incidental files.

### The example world — generated content

`data/showcase_registry.json` and `data/dna_registry.json` contain prose
generated by this framework: settings, characters, factions, and lore. That is
creative content rather than software, so a software licence is the wrong
instrument for it.

It is offered under
[CC BY-NC 4.0](https://creativecommons.org/licenses/by-nc/4.0/).

Use it at your table, remix it, publish your own version of it — credit this
repository, and do not sell it or anything derived from it without asking. As
with the code, a commercial licence is available; just ask.

These files are examples of what the pipeline produces. They are not the world
they came from, which is not published here.

### The Pathfinder 2E cartridge — not mine to license
...
Required Notice: Copyright 2026 Nicholas A. Dallman
https://github.com/PhantomGM/Digital-Narrative-Alchemist-Framework
